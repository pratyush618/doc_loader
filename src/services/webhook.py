...
class WebhookService:
    ...
    async def send_notification(self, webhook_url: str, job: Job, 
    ...
    async def notify_job_status(self, job: Job, result_url: Optional[str] = None) -> None:
        """
        ...
        try:
            await self.send_notification(webhook_url, job, result_url)
